...
exports.api_getgovernanceinfo = "Returns the current governance information, such as when the last and next superblocks are.",
exports.api_getsuperblockbudget = "Returns the available budget for a superblock with the given height.",
